...
ACS_ADMIN_CREDENTIALS = {login: 'jspain@appcelerator.com', password: 'admin'};//{login: 'appcharity', password: '123456'};

// FB SETUP
Ti.Facebook.appid = "454480297929219";
Ti.Facebook.permissions = ['publish_stream', 'read_stream', 'offline_access'];
FB_PAGE = 'SpecialOlympics'; //'msf.english'; // for page retrieval
FB_ID = '10151281924988782'; //'33110852384'; // real fb id for fql calls. You can find out by inspecting fb links

// TWITTER SETUP
TWITTER_SCREEN_NAME = 'SpecialOlympics'; // For page link and tweet @
