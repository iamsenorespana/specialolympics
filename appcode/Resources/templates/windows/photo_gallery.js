var render = function() {
	var topBanner = nrequire('/templates/views/top_banner'), Controller = nrequire('/templates/controllers/photo_gallery'), CroppedImage = nrequire('/ui/cropped_image'), BorderShadows = nrequire('/ui/border_shadows'), photo_size = isIPad ? 340 : (Ti.Platform.displayCaps.platformWidth / 3);
