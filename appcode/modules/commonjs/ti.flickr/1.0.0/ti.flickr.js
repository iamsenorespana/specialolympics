...
//http://api.flickr.com/services/rest/?format=json&method=flickr.people.getPublicPhotos&api_key=&secret=&per_page=5&jsoncallback=test&user_id=60226253@N06
function FlickrExecutor(params, onSuccess, onError){
	//http://api.flickr.com/services/rest/?format=json
	var url=this.endPoint;
	url=url+"&method="+this.httpMethod;
...
function authorize(api_key, secret) {
	sessionOBJ.accessKeyId=api_key;
	sessionOBJ.secretKey=secret;
}

Flickr={};
sessionOBJ.bedFrame.build(Flickr, {
	verb : "GET",
	preparer : function() {
	...
	children : [
		...
		{
		property : "people",
		endPoint : "http://api.flickr.com/services/rest/?format=json",
		executor : FlickrExecutor,
		children : [{
			method : "getPublicPhotos",
			httpMethod: "flickr.people.getPublicPhotos"
		}]
	}, {
		property : "photos",
		endPoint : "http://api.flickr.com/services/rest/?format=json",
